...
require 'data_mapper/relation/relationship'
require 'data_mapper/relation/relationship/join_definition'
require 'data_mapper/relation/relationship/via_definition'
require 'data_mapper/relation/relationship/collection_behavior'
require 'data_mapper/relation/relationship/one_to_many'
require 'data_mapper/relation/relationship/one_to_one'
require 'data_mapper/relation/relationship/many_to_one'
require 'data_mapper/relation/relationship/many_to_many'
require 'data_mapper/relation/relationship/builder/belongs_to'
require 'data_mapper/relation/relationship/builder/has'
